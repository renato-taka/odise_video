...
class ClipAdapter(nn.Module):
    def __init__(self, name="ViT-B-32", normalize=True):
        ...
        if comm.get_local_rank() == 0:
            open_clip.create_model_and_transforms(name, pretrained="openai",cache_dir="/home/carl/Desktop/ODISE")
        comm.synchronize()
    ...
    def _encode_image(self, image):
        ...
        #image embed整个图像的embedding，image_encodings是每个patch的embedding
        else:
