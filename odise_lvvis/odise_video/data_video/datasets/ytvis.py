...
if __name__ == "__main__":
    ...
    meta = MetadataCatalog.get("lvvis_train")

    json_file = "./datasets/LVVIS/train_instances.json"
    image_root = "./datasets/LVVIS/train/JPEGImages"
    dicts = load_ytvis_json(json_file, image_root, dataset_name="lvvis_train")
    logger.info("Done loading {} samples.".format(len(dicts)))

    dirname = "lvvis-data-vis"
